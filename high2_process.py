...
neg_rem, pos_rem = fl_funcs.spur_removal_sep(hmi_neg_mask_c, hmi_pos_mask_c,
                                             ...
                                             ilo = 390, ihi = 500, ihi3 = 420, jlo3 = 425,
                                             ilo2 = 390, ihi2 = 450)
...
pil_mask_c, ivs, dvs, hmik = fl_funcs.pil_gen(pil_mask_c, hmi_dat, threshperc = 0.01)

print("Separation values determination.")

aia8_pos, aia8_neg = fl_funcs.mask_sep(aia_step8, hmi_dat)

pos_rem0, neg_rem0 = fl_funcs.spur_removal_sepopt3(aia8_pos, aia8_neg, klo = 375, jlo = 375, klo2 = 200)
