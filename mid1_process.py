...
pil_right_near_pos_1, pil_left_near_pos_1, pil_right_near_neg_1, pil_left_near_neg_1 \
    = fl_funcs.elon_dist_arrays(lr_coord_pos_1, lr_coord_neg_1, ivs_lim, dvs_lim,
                                ivs_sort, dvs_sort)

pil_right_near_pos_2, pil_left_near_pos_2, pil_right_near_neg_2, pil_left_near_neg_2 \
    = fl_funcs.elon_dist_arrays(lr_coord_pos_2, lr_coord_neg_2, ivs_lim, dvs_lim,
                                ivs_sort, dvs_sort)

lens_pos_1, lens_neg_1 = fl_funcs.elongation(pil_right_near_pos_1, pil_left_near_pos_1,
                                         pil_right_near_neg_1, pil_left_near_neg_1,
                                         sortedpil)

lens_pos_2, lens_neg_2 = fl_funcs.elongation(pil_right_near_pos_2, pil_left_near_pos_2,
                                         pil_right_near_neg_2, pil_left_near_neg_2,
                                         sortedpil)
