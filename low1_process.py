...
level = 'low'
sxr_fn='/Users/coletamburri/Desktop/sci_gxrs-l2-irrad_g15_d20131013_v0-0-0.nc'
...
fl_funcs.plt_fourpanel(times, right_gfr, left_gfr, flnum, dt1600, time304,
                       ...
                       low_hxr=0, high_hxr=800,  period_flag=0, tick_space=30,
                       fllab='Low1',locationleg='upper left',pilparlim=[-0.5,60],pilperplim=[-0.5,9])
